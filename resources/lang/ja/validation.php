...
return [
    ...
    */
    ...
    'required_without'     => ':valuesまたは:attributeが必須です。',
    ...
    */
    ...
    'attributes' => [
        // /manage/company/create
        'kigyo_cd' => '企業ID',
        'kigyo_nm' => '企業名',
        'address' => '所在地',
        'tel' => 'Tel',
        // /manage/functionality/create
        'kinosei_cd' => '機能性食品コード',
        'todokede_no' => '届出番号',
        'todokede_nm' => '届出者名',
        'pict' => '画像',
        'shokuhin_kb' => '食品の区分',
        'hyoji_kinosei' => '表示しようとする機能性',
        'kanyo_seibun_nm' => '機能性関与成分名',
        'info' => '生産・製造及び品質管理に関する情報',
        'henko_rireki' => '変更履歴',
        'kinosei_categories' => '機能性カテゴリ',
        'taisho' => '想定する主な対象者',
        'hyoka' => '安全性の評価方法',
        'hyoka_hoho' => '機能性の評価方法',
        'tekkai_jiyu' => '届出撤回の事由',
        'shohi_info' => '消費者庁届出情報詳細',
        'kanyo_seibun' => '関与成分',
        'genzairyo_nm' => '機能性関与成分を含む原材料名',
        'hp' => '情報表示するウェブサイト',
        'meisho' => '名称',
        // /manage/material/create
        'genryo_id' => '原料ID',
        // 'top_pic' => 'TOP画像',
        // 'hitokoto' => '一言特徴',
        'item_gaiyo' => '商品概要タイトル',
