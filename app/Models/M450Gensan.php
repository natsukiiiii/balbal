 ...
 * Class M450Gensan
 * 
 * @property string $gensan_cd
 * @property string $gensan_nm
 * @property string $gensan_kana
 * @property string $kaigai_flg
 ...
 * @package App\Models
 */
class M450Gensan extends Eloquent
{
	protected $table = 'm450_gensan';
	protected $primaryKey = 'gensan_cd';
